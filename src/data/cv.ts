export const experiences = [
	...
	},
	{
		...
		location: 'Rio de Janeiro, RJ, Brasil',
		description: 'Assistente de pesquisa em um projeto da UPP-Social na favela da Rocinha.',
	},
	{
...
export const bio = 'Discente em Licenciatura em <b>Física na Universidade Federal do Rio de Janeiro</b> (UFRJ), graduando em Engenharia de Computação na Universidade Estácio de Sá (UNESA), possui formação técnica em Eletrônica(IETAAM) com registro ativo no Conselho Federal de Técnicos Industriais (CFT/CRT). Como professor de Cálculo Técnico e Tecnologia da Escola Rural São Vicente de Paulo contribuiu para a formação de centenas de estudantes no Ensino Fundamental I e II lecionando nas áreas de Ciência, Tecnologia, Engenharia e Matemáticas(STEM). Membro do Clube de Engenharia do Brasil, participa ativamente de iniciativas que promovem o desenvolvimento profissional e a troca de conhecimentos técnicos. Atua como consultor de TI em empreendimentos de base tecnológica.  Integrante da rede de empreendimentos sustentáveis da aceleradora Shell Iniciativa Jovem, ajudou dezenas de empresas no desenvolvimento de soluções computacionais para facilitar processos e otimizar resultados. Egresso do programa "NASA Open Science" onde atua como facilitador das práticas de Ciência Aberta em laboratórios de pesquisas. Colabora como Pesquisador Assistente em projetos científicos contribuindo intelectualmente nas áreas de Computação Científica, Ciência Aberta, Modelagem Matemática e Computacional para desenvolver simulações, relatórios e análise de dados que ajudam o cientista a desenvolver melhor a sua pesquisa. '
