...
export const template = {
	website_url: 'https://podercomputacional.com.br/pedropauloportella/about-me/', // Astro needs to know your site’s deployed URL to generate a sitemap. It must start with http:// or https://
	menu_left: false,
	transitions: true,
